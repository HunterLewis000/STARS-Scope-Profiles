...
- Individual VMAPS = An additional folder including some individual video map .geojson file taken straight from CRC with namings. 
...
11. "Ctrl + F2" will access the full list of radar video maps, allowing you to activate those in spots outside of 1-20 and with a reference to their full name 
